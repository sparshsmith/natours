...
exports.protect = catchAsync(async (req, res, next) => {
    ...
    if (!currentUser) {
        return next(new AppError('The user belonging to user does no longer exists.', 401));
    }
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
    //1 Get user based on poosted email
...
exports.resetPassword = catchAsync(async (req, res, next) => {
    ...
    //3 Updatre changedPasswordAt property for the user
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    //1 get the user from the colllection
