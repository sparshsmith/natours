        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status = 'success') {
              ...
              window.setTimeout(function () {
                if (window.location.pathname === '/me' || window.location.pathname === '/my-tour') location.assign('/');else location.reload('/');
              }, 1500);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'passord' ? '/api/v1/users/updateMypassword' : '/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51IhXcaSD18SxPipsWvEAAZvwEgYyIdiDzTuwb6lDv8bcUOhlJBtIrBsDj7sdLlAT4O3wUa9jDpRn0CE38ABIvXNi00MUghu1TF');
...
if (userPasswordForm) {
  userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var btnSave, passordCurrent, passord, passordConfirm;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              btnSave = document.querySelector('.btn--save-password');
              btnSave.textContent = 'Updating...';
              passordCurrent = document.getElementById('password-current').value;
              passord = document.getElementById('password').value;
              passordConfirm = document.getElementById('password-confirm').value;
              _context.next = 8;
              return (0, _updateSettings.updateSettings)({
                passordCurrent: passordCurrent,
                passord: passord,
                passordConfirm: passordConfirm
              }, 'password');
